    ...
    >
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        <div className="flex justify-center mb-8">
          <h1 className=" text-2xl font-bold">Registrar nuevo dollie</h1>
        </div>
        <form onSubmit={handleFormSubmit}>
          <div className=" my-4">
            <label className="block text-sm font-medium text-gray-700">ID del dollie:</label>
            <input
              type="text"
              value={`D-${dollieId}`}
              onChange={(e) => setDollieId(e.target.value.replace(/^D-/, ''))}
